        ...
        <footer className='bg-stone-900 flex justify-center gap-32 pb-4'>
            <section className='pt-4'>
                <div className='flex'>
                    ...
                    <h1 className='text-emerald-400 text-2xl ml-2 font-bold'>Career Dock</h1>
                </div>
                <h2 className='text-zinc-500 text-sm mt-1'>Track your career journey!</h2>
                <Link href='/login' className='block text-emerald-400 mt-4'>Login</Link>
            ...
            <section className='pt-4 text-zinc-100 my-auto'>
                <h1 className='text-xl font-semibold mt-2'>Services</h1>
            ...
            <section className='pt-4 text-zinc-100 my-auto'>
                <h1 className='text-xl font-semibold mt-2'>Legal</h1>
